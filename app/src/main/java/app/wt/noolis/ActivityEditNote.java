...
public class ActivityEditNote extends AppCompatActivity {
    ...
    private void iniComponent()
    {
        ...
        if (is_new) {
            time.setText("");
            cur_category = db.getCategoryById(Constant.DEFAULT_CATEGORY_ID);
        } else {
    ...
    private void setCategoryView(Category category){
        cat_icon.setImageResource(category.getIcon());
        ...
        Tools.systemBarLolipopCustom(ActivityEditNote.this, category.getColor());
    }
